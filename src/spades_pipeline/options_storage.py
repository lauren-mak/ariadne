...
def save_restart_options(log):
    ...
    global restart_assembly_graph
    global restart_run_assembly
    ...
    restart_assembly_graph = assembly_graph
    restart_run_assembly = run_assembly
...
def load_restart_options():
    ...
    if restart_size_cutoff is not None:
        size_cutoff = restart_size_cutoff
    if restart_assembly_graph is not None:
        assembly_graph = restart_assembly_graph
    if restart_run_assembly is not None:
        run_assembly = restart_run_assembly
